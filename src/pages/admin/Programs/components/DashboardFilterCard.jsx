...
function DashboardFilterCard() {
  ...
  const filteredData = () => {
    ...
    return ApplicationInterfaceSliderData.filter(item => item.category === activeFilter)
  }
              ...
              <div className='shadow-lg border-0 rounded-[49px] mb-7 p-2 flex justify-between flex-grow-1 '>
                ...
                <button
                  ...
                  className={`border-0 py-2 md:px-4 px-2 rounded-[25px] text-sm md:text-base ${
                    activeFilter === 'Available' ? ' bg-themeDarkGreen text-white ' : ''
                  }`}
                ...
                <button
                  type='button'
                  className={`border-0 py-2 md:px-4 px-2 rounded-[25px] text-sm md:text-base ${
                    activeFilter === 'Upcoming' ? 'bg-themeDarkGreen text-white' : ''
                  }`}
                ...
                <button
                  type='button'
                  className={`border-0 py-2 md:px-4  px-2 rounded-[25px] text-sm md:text-base ${
                    activeFilter === 'Closed' ? 'bg-themeDarkGreen text-white' : ''
                  }`}
...
const ApplicationInterfaceSliderData = [
  {
    id: 1,
    imgsrc: 'https://benkhan.com/images/articles/Riyadh-The-Dead-Center-of-the-Saudi-Arabia-Kingdom1[1].jpg',
  ...
  {
    id: 2,
    imgsrc: 'https://argaamplus.s3.amazonaws.com/ae7dfaf8-e4f9-4297-8846-4aa2a72a2d81.png',
