...
const VerticalNavbar = () => {
  ...
  const [activeItem, setActiveItem] = useState(
    localStorage.getItem("activeNav") || 1
  ); // Initially set the active item to the first one
    ...
    <div className="flex justify-between items-center h-24 max-w-[1240px] xl:px-0 px-8 mx-auto text-black">
      ...
      {!isMobile && (
        <ul className="flex items-center">
          <div className="relative inline-block text-left">
            <button
              className="font-medium items-center py-2  rounded inline-flex "
      ...
      >
        ...
        <Link href={"/portfolio/home"} className="relative mt-3">
          <img
            src={logo}
            className="img-fluid logo-neu z-10 mt-2 ml-2"
            alt="Logo"
          />
